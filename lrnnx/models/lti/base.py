...
class LTI_LRNN(LRNN):
    ...
    Note:
        LTI models do not support async discretization as that requires
    ...
    def discretize(self) -> tuple[Tensor, Union[Tensor, float], Tensor]:
        ...
        Returns:
            tuple[torch.Tensor, torch.Tensor | float, torch.Tensor]: A tuple of tensors representing the
    ...
    def compute_kernel(self, *args, **kwargs) -> tuple[Tensor, Tensor]:
        ...
        Args:
            *args: Model-specific arguments (e.g., sequence length,
    ...
    def allocate_inference_cache(
        ...
        **kwargs,
        ...
        Args:
            ...
            max_seqlen (int, optional): Maximum sequence length (unused for LTI, kept
